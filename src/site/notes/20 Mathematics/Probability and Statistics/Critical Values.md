---
{"dg-publish":true,"permalink":"/20 Mathematics/Probability and Statistics/Critical Values/","dg-note-properties":{}}
---

# Critical Values

Critical values are the cut-off points that separate the critical region from the non-critical region in a [[20 Mathematics/Probability and Statistics/hypothesis testing\|hypothesis test]] or determine the width of a [[20 Mathematics/Probability and Statistics/Confidence Interval\|confidence interval]].
...
### z-Critical Values ($z^*$)
Used with:
- [[20 Mathematics/Probability and Statistics/Normal Distribution\|Normal Distribution]]
...
### t-Critical Values ($t^*$)
Used with:
- [[20 Mathematics/Probability and Statistics/t-distribution\|t-distribution]]
- Mean-based tests and intervals

t-critical values depend on:
- Confidence level
- [[20 Mathematics/Probability and Statistics/degrees of freedom\|degrees of freedom]] (df = $n-1$)
...
See also:
- [[20 Mathematics/Probability and Statistics/Confidence Interval\|Confidence Interval]]
- [[20 Mathematics/Probability and Statistics/hypothesis testing\|hypothesis testing]]
- [[20 Mathematics/Probability and Statistics/Standard error\|Standard Error]]
- [[20 Mathematics/Probability and Statistics/t-distribution\|t-distribution]]
- [[20 Mathematics/Probability and Statistics/Normal Distribution\|Normal Distribution]] 