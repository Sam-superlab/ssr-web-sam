---
{"dg-publish":true,"permalink":"/20 Mathematics/Probability and Statistics/Expectation value and Variance/","dg-note-properties":{}}
---

## Defintion of Expectation
>**Expected Value**($E(X)$) to denote that this is an average(or [[20 Mathematics/Probability and Statistics/mean\|mean]]) for a random variable$$E(X)=x_{i} p_{i}$$
