---
{"dg-publish":true,"permalink":"/20 Mathematics/Probability and Statistics/Numerical Summaries/","dg-note-properties":{}}
---

>**Numerical Summaries** calculating numbers that tell us about certain aspects of the data

Here are some key concepts:
1. [[20 Mathematics/Probability and Statistics/Center\|Center]]
2. [[20 Mathematics/Probability and Statistics/Spread\|Spread]]
3. [[20 Mathematics/Probability and Statistics/Shape\|Shape]]
4. [[20 Mathematics/Probability and Statistics/Outliers\|Outliers]]

Basically, when we wish to discuss about **center** and **spread**, there are two separate approach:

- [[20 Mathematics/Probability and Statistics/Order Statistics\|Order Statistics]]
- [[20 Mathematics/Probability and Statistics/moment statistics\|moment statistics]]
...
**Standardizing our value**s is a way of adjusting them so that we can directly compare them. These adjusted values are called [[20 Mathematics/Probability and Statistics/z-scores\|z-scores]].
