---
{"dg-publish":true,"permalink":"/30 Courses/Computer Science 2/Lists/","dg-note-properties":{}}
---

- [[30 Courses/Computer Science 2/Lists#**List Basics Overview**:\|**List Basics Overview**:]]
- [[30 Courses/Computer Science 2/Lists#**Five Basic Concepts for a New Data Type**:\|**Five Basic Concepts for a New Data Type**:]]
- [[30 Courses/Computer Science 2/Lists#**Displaying Lists**:\|**Displaying Lists**:]]
- [[30 Courses/Computer Science 2/Lists#**Creating Lists**:\|**Creating Lists**:]]
- [[30 Courses/Computer Science 2/Lists#**Common List Operations**:\|**Common List Operations**:]]
- [[30 Courses/Computer Science 2/Lists#**List Transformations Overview**:\|**List Transformations Overview**:]]
- [[#**Transformation through `map`**:|**Transformation through `map`**:]]
- [[30 Courses/Computer Science 2/Lists#**Transformation Flexibility**:\|**Transformation Flexibility**:]]
- [[30 Courses/Computer Science 2/Lists#**Transforming Other Types of Data**:\|**Transforming Other Types of Data**:]]
- [[30 Courses/Computer Science 2/Lists#**Errors and Type Matching**:\|**Errors and Type Matching**:]]
- [[#**Using `apply`**:|**Using `apply`**:]]
- [[30 Courses/Computer Science 2/Lists#**Dealing with Complex Data**:\|**Dealing with Complex Data**:]]
- [[#**Error Handling in `map` and `apply`**:|**Error Handling in `map` and `apply`**:]]
- [[30 Courses/Computer Science 2/Lists#**Summary**:\|**Summary**:]]
